...
var Point = (
  ...
  function() {
    ...
    Point2.prototype.add = function(pt) {
      return new Point2(this.x + pt.x, this.y + pt.y);
    };
    Point2.prototype.sub = function(pt) {
      return new Point2(this.x - pt.x, this.y - pt.y);
    };
    Point2.prototype.mul = function(pt) {
      return new Point2(this.x * pt.x, this.y * pt.y);
    };
    Point2.prototype.div = function(pt) {
      return new Point2(this.x / pt.x, this.y / pt.y);
    };
...
var Box = (
  ...
  function() {
    function Box2(_box, allowNegativeDimensions) {
      ...
      var _a = isRect ? [box.x, box.y, box.width, box.height] : [box.left, box.top, box.right - box.left, box.bottom - box.top], x = _a[0], y = _a[1], width = _a[2], height = _a[3];
      Box2.assertIsValidBox({ x, y, width, height }, "Box.constructor", allowNegativeDimensions);
      this._x = x;
      this._y = y;
      this._width = width;
      this._height = height;
    ...
    Box2.prototype.rescale = function(s) {
...
function minBbox(pts) {
  ...
  var maxX = xs.reduce(function(max2, x) {
    return max2 < x ? x : max2;
  }, 0);
  var maxY = ys.reduce(function(max2, y) {
    return max2 < y ? y : max2;
  }, 0);
...
var Rect = (
  ...
  function(_super) {
    ...
    function Rect2(x, y, width, height, allowNegativeDimensions) {
      ...
      return _super.call(this, { x, y, width, height }, allowNegativeDimensions) || this;
    }
    return Rect2;
  }(Box)
);
...
var FaceLandmarks = (
  ...
  function() {
    ...
    FaceLandmarks2.prototype.shiftBy = function(x, y) {
      return new this.constructor(this.relativePositions, this._imgDims, new Point(x, y));
    };
    FaceLandmarks2.prototype.shiftByPoint = function(pt) {
...
function monkeyPatch(env2) {
  ...
  var _a = env2.Canvas, Canvas = _a === void 0 ? environment.Canvas : _a, _b = env2.Image, Image = _b === void 0 ? environment.Image : _b;
...
function getContext2dOrThrow(canvasArg) {
  var _a = env.getEnv(), Canvas = _a.Canvas, CanvasRenderingContext2D2 = _a.CanvasRenderingContext2D;
    ...
    return __generator(this, function(_b) {
      switch (_b.label) {
        case 0:
          ...
          return [4, browser_exports.toPixels(imgTensor3D, targetCanvas)];
        case 1:
          _b.sent();
          imgTensor3D.dispose();
    ...
    return __generator(this, function(_b) {
      switch (_b.label) {
        ...
        case 5:
          ...
          return [2, boxes.map(function(_a2) {
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(_b) {
      switch (_b.label) {
        ...
        case 2:
          return [2, new (_a.apply(Float32Array, [void 0, _b.sent()]))()];
      }
    });
  });
}
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(_b) {
      switch (_b.label) {
        ...
        case 1:
          manifest = _b.sent();
          return [2, io_exports.loadWeights(manifest, modelBaseUri)];
      }
    });
  });
}
...
function matchDimensions(input, reference, useMediaDimensions) {
  ...
  var _a = useMediaDimensions ? getMediaDimensions(reference) : reference, width = _a.width, height = _a.height;
  input.width = width;
  input.height = height;
  return { width, height };
}
  ...
  function() {
    ...
    NeuralNetwork2.prototype.variable = function() {
      ...
      this.getFrozenParams().forEach(function(_a) {
        var path = _a.path, tensor2 = _a.tensor;
    ...
    NeuralNetwork2.prototype.freeze = function() {
      ...
      this.getTrainableParams().forEach(function(_a) {
        ...
        var tensor2 = tensor(variable.dataSync());
        variable.dispose();
        ...
        return __generator(this, function(_d) {
          switch (_d.label) {
            case 0:
              ...
              loadWeights = io_exports.weightsLoaderFactory(fetchWeightsFromDisk);
              _c = (_b = JSON).parse;
...
function denseBlock3(x, denseBlockParams, isFirstLayer) {
  ...
  return tidy(function() {
    var out1 = relu(isFirstLayer ? add(conv2d(x, denseBlockParams.conv0.filters, [2, 2], "same"), denseBlockParams.conv0.bias) : depthwiseSeparableConv(x, denseBlockParams.conv0, [2, 2]));
...
function denseBlock4(x, denseBlockParams, isFirstLayer, isScaleDown) {
  ...
  return tidy(function() {
    var out1 = relu(isFirstLayer ? add(conv2d(x, denseBlockParams.conv0.filters, isScaleDown ? [2, 2] : [1, 1], "same"), denseBlockParams.conv0.bias) : depthwiseSeparableConv(x, denseBlockParams.conv0, isScaleDown ? [2, 2] : [1, 1]));
    var out2 = depthwiseSeparableConv(out1, denseBlockParams.conv1, [1, 1]);
    var in3 = relu(add(out1, out2));
    var out3 = depthwiseSeparableConv(in3, denseBlockParams.conv2, [1, 1]);
...
function extractorsFactory(extractWeights, paramMappings) {
  ...
  function extractDenseBlock4Params(channelsIn, channelsOut, mappedPrefix, isFirstLayer) {
    ...
    var _a = extractDenseBlock3Params(channelsIn, channelsOut, mappedPrefix, isFirstLayer), conv0 = _a.conv0, conv1 = _a.conv1, conv22 = _a.conv2;
      ...
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            ...
            case 2:
              out = _a.sent();
              return [4, Promise.all(unstack(out).map(function(t) {
...
function drawFaceExpressions(canvasArg, faceExpressions, minConfidence, textFieldAnchor) {
  ...
  faceExpressionsArray.forEach(function(e) {
    var expr = e instanceof FaceExpressions ? e : isWithFaceExpressions(e) ? e.expressions : void 0;
    if (!expr) {
...
function drawFaceLandmarks(canvasArg, faceLandmarks) {
  ...
  faceLandmarksArray.forEach(function(f) {
    var landmarks = f instanceof FaceLandmarks ? f : isWithFaceLandmarks(f) ? f.landmarks : void 0;
    if (!landmarks) {
...
function extractParamsFromWeigthMap3(weightMap, numMainBlocks) {
  var paramMappings = [];
  var _a = loadParamsFactory2(weightMap, paramMappings), extractConvParams = _a.extractConvParams, extractSeparableConvParams = _a.extractSeparableConvParams, extractReductionBlockParams = _a.extractReductionBlockParams, extractMainBlockParams = _a.extractMainBlockParams;
...
function mainBlock(x, params) {
  var out = depthwiseSeparableConv(relu(x), params.separable_conv0, [1, 1]);
  out = depthwiseSeparableConv(relu(out), params.separable_conv1, [1, 1]);
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            ...
            case 2:
              ...
              return [4, Promise.all(ageAndGenderTensors.map(function(_a2) {
  ...
  function(_super) {
    ...
    FaceLandmark68NetBase2.prototype.postProcess = function(output, inputSize, originalDimensions) {
      ...
      return tidy(function() {
        ...
        var landmarkTensors = output.mul(fill([batchSize, 136], inputSize)).sub(stack(Array.from(Array(batchSize), function(_, batchIdx) {
                ...
                return __awaiter(_this, void 0, void 0, function() {
                  ...
                  return __generator(this, function(_c) {
                    switch (_c.label) {
                      ...
                      case 1:
                        landmarksArray = _b.apply(_a2, [_c.sent()]);
                        ...
                        return [2, new FaceLandmarks68(Array(68).fill(0).map(function(_, i) {
...
function convLayer2(x, params, strides, withRelu, padding) {
  if (padding === void 0) {
    padding = "same";
  }
...
function extractParamsFromWeigthMap5(weightMap) {
  var paramMappings = [];
  var _a = extractorsFactory4(weightMap, paramMappings), extractConvLayerParams = _a.extractConvLayerParams, extractResidualLayerParams = _a.extractResidualLayerParams;
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [4, Promise.all(faceDescriptorTensors.map(function(t) {
                return t.data();
              }))];
            case 2:
...
function extractParamsFromWeigthMap6(weightMap) {
  var paramMappings = [];
  var _a = extractorsFactory6(weightMap, paramMappings), extractMobilenetV1Params = _a.extractMobilenetV1Params, extractPredictionLayerParams = _a.extractPredictionLayerParams;
...
function nonMaxSuppression2(boxes, scores, maxOutputSize, iouThreshold, scoreThreshold) {
  ...
  candidates.forEach(function(c) {
    ...
    for (var j = selected.length - 1; j >= 0; --j) {
      var iou2 = IOU(boxes, c.boxIndex, selected[j]);
      if (iou2 === 0) {
        continue;
      }
...
var SsdMobilenetv1Options = (
  /** @class */
  function() {
    function SsdMobilenetv1Options2(_a) {
...
function extractorsFactory7(extractWeights, paramMappings) {
  ...
  function extractBatchNormParams(size, mappedPrefix) {
    var sub2 = tensor1d(extractWeights(size));
...
function extractParamsFromWeigthMap7(weightMap, config) {
  var paramMappings = [];
  var _a = extractorsFactory8(weightMap, paramMappings), extractConvParams = _a.extractConvParams, extractConvWithBatchNormParams = _a.extractConvWithBatchNormParams, extractSeparableConvParams = _a.extractSeparableConvParams;
  var params;
  if (config.withSeparableConvs) {
...
var TinyYolov2Options = (
  /** @class */
  function() {
    function TinyYolov2Options2(_a) {
...
var TinyYolov2Base = (
  ...
  function(_super) {
    ...
    TinyYolov2Base2.prototype.runMobilenet = function(x, params) {
      var out = this.config.isFirstLayerConv2d ? leaky(convLayer(x, params.conv0, "valid", false)) : depthwiseSeparableConv2(x, params.conv0);
      out = maxPool(out, [2, 2], [2, 2], "same");
        ...
        return __generator(this, function(_b) {
          switch (_b.label) {
            case 0:
              ...
              return [4, toNetInput(input)];
            case 1:
              return [4, _a.apply(this, [_b.sent(), inputSize])];
            case 2:
              return [2, _b.sent()];
          }
        });
          ...
          switch (_d.label) {
            case 0:
              ...
              _a = tidy(function() {
                ...
                var classScores = _this.withClassScores ? softmax(reshaped.slice([0, 0, 0, 5], [numCells, numCells, numBoxes, _this.config.classes.length]), 3) : scalar(0);
            ...
            case 8:
              ...
              results.push(__assign({ box: new BoundingBox(x, y, x + width_1, y + height_1), score, classScore: score * classScore, label }, pos));
              _d.label = 9;
            case 9:
              anchor++;
              return [3, 5];
      ...
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            ...
            case 1:
              classesData = _a.sent();
              return [2, Array(this.config.classes.length).fill(0).map(function(_, i) {
...
function extractParamsFromWeigthMap8(weightMap) {
  var paramMappings = [];
  var _a = extractorsFactory10(weightMap, paramMappings), extractPNetParams = _a.extractPNetParams, extractRNetParams = _a.extractRNetParams, extractONetParams = _a.extractONetParams;
  var pnet = extractPNetParams();
  var rnet = extractRNetParams();
  var onet = extractONetParams();
  disposeUnusedWeightTensors(weightMap, paramMappings);
...
function getSizesForScale(scale2, _a) {
  var height = _a[0], width = _a[1];
  return {
...
function pyramidDown(minFaceSize, scaleFactor, dims) {
  ...
  var exp2 = 0;
  while (minLayer >= 12) {
    scales.push(m * Math.pow(scaleFactor, exp2));
...
function normalize2(x) {
  return tidy(function() {
    return mul(sub(x, scalar(127.5)), scalar(78125e-7));
  });
}
...
function rescaleAndNormalize(x, scale2) {
  return tidy(function() {
    var _a = getSizesForScale(scale2, x.shape.slice(1)), height = _a.height, width = _a.width;
...
function stage1(imgTensor, scales, scoreThreshold, params, stats) {
  ...
  var pnetOutputs = scales.map(function(scale2) {
    return tidy(function() {
      ...
      statsForScale.pnet = Date.now() - ts2;
  ...
  var boxesForScale = pnetOutputs.map(function(_a) {
    var scoresTensor = _a.scoresTensor, regionsTensor = _a.regionsTensor, scale2 = _a.scale, statsForScale = _a.statsForScale;
    ...
    statsForScale.nms = Date.now() - ts2;
      ...
      switch (_b.label) {
        case 0:
          ...
          return [4, Promise.all(boxes.map(function(box) {
            return __awaiter(_this, void 0, void 0, function() {
              var _a2, y, ey, x, ex, fromX, fromY, imgData;
              return __generator(this, function(_b2) {
                _a2 = box.padAtBorders(img.height, img.width), y = _a2.y, ey = _a2.ey, x = _a2.x, ex = _a2.ex;
                fromX = x - 1;
                fromY = y - 1;
          ...
          switch (_c.label) {
            case 0:
              ...
              imgTensor = tidy(function() {
                return bgrToRgbTensor(expandDims(browser_exports.fromPixels(inputCanvas)).toFloat());
              });
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            ...
            case 2:
              ...
              return [2, parentResults.map(function(parentResult, i) {
                var _a2 = ageAndGenderByFace[i], age = _a2.age, gender = _a2.gender, genderProbability = _a2.genderProbability;
      ...
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            ...
            case 2:
              descriptors = _a.sent();
              return [2, descriptors.map(function(descriptor, i) {
